    ...
    return (
        <nav>
            <div className='nav-container'>
                <Link to={'/'}><div className='logo'><img src='/bookapp-search/images/ebook.png' alt='logo'/> <h1>BoookSearch</h1></div><h1 className='action-call'>Find your best book yet!</h1></Link>
                <form onSubmit={handleSearch}>
                    <div className="search-box">
                        ...
                        <button type="submit" className="searchButton">
                            <img className='search-image' alt="search" src="/bookapp-search/images/search.png"/>
                        </button>
                    </div>
                </form>
